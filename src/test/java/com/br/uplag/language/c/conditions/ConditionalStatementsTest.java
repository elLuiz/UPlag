...
public class ConditionalStatementsTest {
    ...
    @Test
    public void shouldFindAllOccurrencesOfElsesAndIfs() {
        Pattern pattern = Pattern.compile(ConditionalsRegex.IF_CONDITIONAL_STATEMENT.getRegex(), Pattern.MULTILINE);
        Matcher matcher = pattern.matcher(code);
        System.out.println(matcher.replaceAll(" COND "));
    }
}
